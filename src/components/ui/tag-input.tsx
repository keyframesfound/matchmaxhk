          ...
          <div className="max-h-56 overflow-y-auto p-1 text-xs">
            ...
            {filteredSuggestions.map((option) => (
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-between rounded-md px-2.5 py-1.5 text-xs font-medium text-[color:var(--ink)] transition-colors hover:bg-[color:var(--foreground)]/[0.06] text-left"
              >
            ...
            {canAddCustom && (
              <div className="border-t border-[color:var(--ink)]/10 mt-1 pt-1">
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-md px-2.5 py-1.5 text-xs font-semibold text-[color:var(--brand-link)] hover:bg-[color:var(--foreground)]/[0.06] text-left"
                >
