    ...
    return (
      ...
      >
        ...
        <CommandPrimitive.Input
          ref={ref}
          className={cn(
            "flex h-10 w-full rounded-md bg-transparent py-3 text-sm font-medium text-[color:var(--ink)] outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex min-h-10 cursor-default items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-[color:var(--ink)] outline-none transition-colors data-[disabled=true]:pointer-events-none data-[selected=true]:bg-[color:var(--accent)] data-[selected=true]:text-[color:var(--ink)] data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      className,
    )}
    {...props}
  />
