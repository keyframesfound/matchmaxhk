...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Find qualified Hong Kong tutors matched to your subject, level, district and budget. Post a case for free on MatchMax." },
      { name: "author", content: "MatchMax" },
      { property: "og:title", content: "MatchMax — Hong Kong's smart tutoring marketplace" },
      { property: "og:description", content: "Smart matching for Hong Kong families. Connect with qualified tutors in minutes." },
