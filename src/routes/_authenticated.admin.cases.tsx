      ...
      <main className="flex-1">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Approve to publish to the tutor board. Reject or close to hide.
          </p>
          ...
          {isLoading ? (
            <div aria-label="Loading cases" className="mt-6 space-y-3">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        {r.subject} · {r.student_level} · {r.district ?? "Any"} · HK$
                        {r.budget_min ?? 0}–{r.budget_max ?? "?"}/hr
                      </p>
                      <p className="mt-1 text-xs text-muted-foreground">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Select
                        value={r.status}
                        onValueChange={(v) =>
                          mutation.mutate({ caseId: r.id, status: v as Status })
                        }
                      >
