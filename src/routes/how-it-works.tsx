...
function ComparisonTable({ title, rows }: { title: string; rows: ComparisonRow[] }) {
  ...
  return (
    <div>
      ...
      <div className="mt-5 rounded-2xl border border-[color:var(--hiw-compare-card-border)] bg-[color:var(--hiw-compare-card)] p-5 md:p-8">
        <div className="hidden gap-x-10 border-b border-[color:var(--ink)]/20 pb-4 md:grid md:grid-cols-[minmax(0,0.9fr)_minmax(0,1fr)_minmax(0,1.2fr)]">
          ...
          <p className="md:rounded-t-lg md:bg-[color:var(--hiw-compare-max)] md:-mt-4 md:pt-4 md:-mb-4 md:pb-4 md:pl-4 text-sm font-bold text-[color:var(--brand-link)]">
            {t("hiw.table_max")}
          </p>
        </div>
        <ul>
