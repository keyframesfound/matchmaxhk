  ...
  head: () => ({
    meta: [
      { title: "MatchMax — Hong Kong's tutoring marketplace" },
      {
        name: "description",
        content:
          "⚡️ Instantly matched to the perfect Hong Kong tutor. 🎓 Verified IB, IGCSE, DSE, and AP top-scorer tutors ready to help.",
      },
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:pt-24 lg:pb-28">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="h-14 bg-[color:var(--brand-navy)] px-8 text-base font-bold text-white shadow-brand hover:bg-[color:var(--brand-royal)]"
              >
                <Link to="/tutors">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <BadgeCheck className="h-4 w-4 text-[color:var(--brand-teal)]" /> Verified tutors
              </span>
              <span className="inline-flex items-center gap-1.5">
                <MessageCircle className="h-4 w-4 text-[color:var(--brand-teal)]" /> WhatsApp
                handoff
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Star className="h-4 w-4 text-[color:var(--brand-teal)]" /> No hidden fees
              </span>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-md">
              <div
                className="absolute -inset-4 rounded-3xl bg-brand-gradient opacity-20 blur-2xl"
                aria-hidden
              />
              <div className="relative rounded-3xl border border-border bg-card p-6 shadow-brand">
                {heroTutor ? (
                  <>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="truncate text-sm font-bold text-foreground">
                          {heroTutor.display_name}
                        </p>
                        <p className="truncate text-xs text-muted-foreground">
                          {heroTutor.headline ?? heroTutor.subjects.slice(0, 3).join(" · ")}
                        </p>
                      </div>
                      <span className="rounded-full bg-[color:var(--brand-teal)]/10 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-[color:var(--brand-teal)]">
                        Featured
                      </span>
                    </div>
                    <div className="mt-5 grid grid-cols-3 gap-3 rounded-2xl bg-muted/50 p-4 text-center text-xs">
                      <div>
                        <p className="font-bold text-lg text-[color:var(--brand-navy)]">
                    ...
                    <Button
                      asChild
                      className="mt-6 w-full rounded-xl bg-brand-gradient py-3 text-sm font-bold text-white shadow-teal"
                    >
      ...
      <section id="how" className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-4xl font-black tracking-tight text-[color:var(--brand-navy)] sm:text-5xl">
              {t("how.title")}
            </h2>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3">
            {[1, 2, 3].map((n) => (
              <div
                key={n}
                className="group relative rounded-3xl border border-border bg-card p-8 transition-all hover:border-[color:var(--brand-teal)]/40 hover:shadow-brand"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Button asChild variant="outline" className="font-bold">
              <Link to="/tutors">
                {t("featured.view_all")} <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
          {featuredLoading && (
          ...
          <div className="relative overflow-hidden rounded-3xl bg-[color:var(--brand-navy)] p-10 sm:p-14">
            ...
            <div className="relative flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
              ...
              <Button
                asChild
                size="lg"
                className="h-14 bg-white px-8 text-base font-bold text-[color:var(--brand-navy)] hover:bg-white/90"
              >
      ...
      <section className="bg-muted/30 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-3 text-center text-muted-foreground">
            Real reviews from parents and students. Admins can add or edit reviews on each tutor's
            profile.
          </p>
