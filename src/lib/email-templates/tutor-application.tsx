...
export const TutorApplicationEmail = ({ applicantName, rows }: TutorApplicationEmailProps) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={intro}>Submitted via the MatchMax tutor application page (/join).</Text>
        <Hr style={hr} />
        {rows.map((row) => (
        ...
        <Hr style={hr} />
        <Text style={footer}>Reply directly to this email to reach the applicant.</Text>
      </Container>
    </Body>
  </Html>
);
